...
CFLAGS=  -DANDROID -I/Users/loneswordman/Downloads/ffmpeg_libfdkaac_x264/FFmpeg_libfdkaac_x264/jni/ffmpeg-3.2.5/../out/armeabi-v7a/include -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -marm -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++98
OBJCFLAGS=  
ASFLAGS=  -DANDROID -I/Users/loneswordman/Downloads/ffmpeg_libfdkaac_x264/FFmpeg_libfdkaac_x264/jni/ffmpeg-3.2.5/../out/armeabi-v7a/include -march=armv7-a -fPIC
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
