...
JNIEXPORT jboolean
Java_com_guagua_nativeapp_nativehandler_NativeCrashHandler_nRegisterForNativeCrash(JNIEnv *env,
                                                                                   jobject obj) {
...
Java_com_guagua_nativeapp_nativehandler_NativeCrashHandler_nUnregisterForNativeCrash(JNIEnv *env,
                                                                                     jobject) {
...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    applicationClass = env->FindClass("com/guagua/nativeapp/nativehandler/NativeCrashHandler");
