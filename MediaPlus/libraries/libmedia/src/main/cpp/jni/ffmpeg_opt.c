...
static int open_output_file(OptionsContext *o, const char *filename) {
    ...
    if (!strcmp(filename, "-"))
     ...
     AVOutputFormat *f1 = av_guess_format("flv", NULL, NULL);
     AVOutputFormat *f2 = av_guess_format(NULL, "/mnt/sdcard/test.mp3", NULL);

    LOG_D(DEBUG,"f1: %d",f1->audio_codec)
    LOG_D(DEBUG,"f2: %d",f2->audio_codec)
